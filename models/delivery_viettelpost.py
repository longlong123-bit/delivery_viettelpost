...
from odoo.addons.delivery_viettelpost.common.func import Func, Action
from odoo.addons.delivery_viettelpost.dataclass.viettelpost_order import Order
...
class ProviderViettelPost(models.Model):
    ...
    def viettelpost_cancel_shipment(self, picking):
        ...
        viettelpost_service = [rec.id for rec in picking.sale_id.order_line if rec.is_delivery and rec.product_id.id ==
                               self.env.ref('delivery_viettelpost.product_product_delivery_viettelpost').id]
