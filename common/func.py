...
from odoo.addons.delivery_viettelpost.api.viettelpost_client import ViettelpostClient
...
class Func:
    ...
    def get_client_viettelpost(self) -> ViettelpostClient:
        viettelpost_carrier = self.env.ref('delivery_viettelpost.free_delivery_carrier_viettelpost')
