...
from odoo.addons.delivery_viettelpost.dataclass.viettelpost_webhook import Webhook
...
def get_next_sequence() -> str:
    sequence = request.env.ref('delivery_viettelpost.seq_viettelpost_webhook_history')
